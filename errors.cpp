...
const std::map<int, std::string> grbl_error::MESSAGES = {
	...
	{ 24, "Two G-code commands that both require the use of the "
          "XYZ axis words were detected in the block." },
	...
	{ 30, "The G53 G-code command requires either a G0 seek or G1 feed motion "
	...
	{ 34, "A G2 or G3 arc, traced with the radius definition, had a mathematical error when computing the arc geometry. "
          "Try either breaking up the arc into semi-circles or quadrants, or redefine them with the arc offset definition." },
	{ 35, "A G2 or G3 arc, traced with the offset definition, is missing the IJK offset word in the selected plane to trace the arc." },
	{ 36, "There are unused, leftover G-code words that are not used by any command in the block." },
	{ 37, "The G43.1 dynamic tool length offset command cannot apply an offset to an axis other "
          "than its configured axis. The Grbl default axis is the Z-axis." }
};


const std::map<int, std::string> grbl_alarm::MESSAGES = {    
